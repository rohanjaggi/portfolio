...
import ContactComponent from "./contact-me";
...
const LossCurve = dynamic(() => import("@/components/ui/loss-curve"), { ssr: false });
const TemperatureSlider = dynamic(() => import("@/components/ui/temperature-slider"), { ssr: false });
